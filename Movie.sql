...
VALUES 
(2001, 'Dune: Hành Tinh Cát', 'dune_trailer.mp4', 'dune_poster.jpg', 'Cuộc chiến vương quyền giữa các thiên hà trên hành tinh Arrakis.', '2026-02-15', 9, 1, 1, 0),
(2002, 'Parasite: Ký Sinh Trùng', 'parasite_trailer.mp4', 'parasite.png', 'Câu chuyện châm biếm về sự phân hóa giàu nghèo trong xã hội hiện đại.', '2026-06-10', 10, 1, 0, 1),
(2003, 'Your Name', 'your_name.mp4', 'kimi_no_nawa.jpg', 'Hai thiếu niên xa lạ bỗng nhiên bị hoán đổi thân xác cho nhau.', '2026-08-20', 9, 0, 0, 1);
...
VALUES
(1, 1, 2001, '2026-03-05 18:00:00', 90000),
(2, 2, 2001, '2026-03-10 20:00:00', 100000),
(3, 3, 2002, '2026-06-11 19:00:00', 85000);
